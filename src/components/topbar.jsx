...
function Topbar() {
    ...
    const checkLogin = async () => {
        try {
            const res = await axios.get('http://localhost:5000/api/users/check-login', { 
    ...
    // Adiciona e remove o listener para mudanças no estado de login
    useEffect(() => {
        checkLogin();
    ...
    return (
        <div className='fixed-top'>
            <nav className="navbar navbar-expand-lg bg-light text-dark px-5" style={navStyle}>
                            ...
                            <div className="dropdown">
                                ...
                                <ul className="dropdown-menu dropdown-menu-end">
                                    <li className="d-flex align-items-center p-2 px-3">
                                        ...
                                        <NavLink 
                                            to="/configuracoes" 
                                            className={({ isActive }) => isActive ? "dropdown-item px-3 inactive" : "dropdown-item px-3"}
                                        >
                                            Configurações
                                        </NavLink>
                                    </li>
